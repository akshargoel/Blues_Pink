...
import Event from '../components/galleryComponents/Event';
        ...
        <div className="mb-16">
          ...
          <div className="relative overflow-hidden rounded-lg shadow-lg">
            <div className="flex overflow-x-auto gap-4">
              {["/images/school.jpeg","/images/school.jpeg","/images/school.jpeg", "/images/school.jpeg", "/images/school.jpeg"].map((img, i) => (
                <motion.img
                  key={i}
                  src={img}
                  alt={`Activity ${i + 1}`}
